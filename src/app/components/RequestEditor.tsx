...
export function RequestEditor() {
  ...
  const handleSend = useCallback(async () => {
    ...
    await executeRequest(JSON.stringify(config), envVars);
  }, [config, isDirty, activeRequestId, handleSave, getResolvedVariables, executeRequest]);
  ...
  return (
    ...
    >
      ...
      <Tabs
        activeKey={activeTab}
        onChange={(key) =>
          setActiveTab(key as 'params' | 'headers' | 'body' | 'auth')
        }
        size="small"
